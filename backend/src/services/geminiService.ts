...
const STYLE_PRESETS: Record<string, any> = {
  photorealistic: {
    ...
    negative:
      'cartoon, anime, illustration, comic art, painting, cel shading, distorted anatomy, low quality'
  },
  ...
  anime: {
    ...
    styleDetails: `
      ...
      anime movie lighting,
      detailed cel shading,
      expressive anime eyes,
      Makoto Shinkai inspired atmosphere,
      dynamic anime framing,
      vibrant cinematic color harmony.`,
  ...
  ghibli: {
    ...
    styleDetails: `
      Soft painterly environments,
      warm emotional lighting,
      dreamlike scenery,
      gentle hand-painted textures,
      Hayao Miyazaki inspired composition,
      natural whimsical atmosphere,
  ...
  watercolor: {
    ...
    styleDetails: `
      ...
      delicate pigment blending,
      pastel palette,
      traditional watercolor painting aesthetic.`,
...
const buildVisualPrompt = (
  ...
  return `
      ...
      4-panel sequential storyboard layout with cinematic composition and clean gutters.

      PANEL 1:
      [scene action, environment, mood, cinematic framing]

      PANEL 2:
      [character interaction, emotional focus, atmosphere]
      ...
      Visual atmosphere:
      [lighting behavior, environment mood, cinematic depth]
